    ...
    return (
      <Centered>
        <div className="instructions">
          ...
          <p>
            In each task (or round), you will be asked to assign students to
          ...
          <p>
            ...
            icon of that student and drop it into the corresponding room. Try
            this example:
          </p>
